...
export default function Contact() {
  return (
    <section className="w-full bg-[#eebe1b]">
      <div className="flex flex-col gap-6">
        {/* Instagram */}
        <div className="flex flex-col gap-3 items-center justify-center py-6 px-2">
          <p className="md:text-lg font-bold text-white text-center">
            Follow Us on Instagram
          </p>
          <button className="text-white px-6 py-2 text-4xl rounded-full font-bold hover:scale-105 transform transition-all duration-300">
            #bakeryshop
          </button>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-6 gap-4">
            {images.map((src, index) => (
              <motion.div
                key={index}
                className="relative overflow-hidden rounded-xl shadow-lg flex w-[150px] h-[150px] md:w-[200px] md:h-[200px]"
